...
public class CutThroatComputerPlayer extends ComputerPlayer {
    ...
    private int blockFork() {
        ...
        // special case
        if (TicTacToeBoard.getSpace(5)==theirSymbol && TicTacToeBoard.getSpace(9)==theirSymbol && TicTacToeBoard.getSpace(1)==ourSymbol && TicTacToeBoard.getSpace(3)==0) return 3;
        
        // fork type 1
        else if(TicTacToeBoard.getSpace(1)==theirSymbol && TicTacToeBoard.getSpace(9)==theirSymbol && TicTacToeBoard.getSpace(2)==0)      return 2;
        ...
        // special case
        else if (TicTacToeBoard.getSpace(6)==theirSymbol && TicTacToeBoard.getSpace(8)==theirSymbol && TicTacToeBoard.getSpace(5)==ourSymbol && TicTacToeBoard.getSpace(9)==0) return 9;
