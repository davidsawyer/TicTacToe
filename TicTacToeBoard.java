...
public class TicTacToeBoard implements Board {
	...
	//Postcondition: Draws the board with pipes and dashes and prints out any marks currently in place.
	...
	//Precondition: There is a board and a player has entered in a space to mark
	//Postcondition: The corresponding space is marked with a 1 or a 2, which translates
...
}	//Precondition: There is a space to retrieve.
	//Postcondion: The space is returned.
	...
	//Postcondition: It is now the opposite player's turn.
...
}    //Postcondition: Returns whose turn it is. Player O is implicitely false.
	public static boolean isPlayerX(){
	
	return playerX;
}	
	//Postcondition: Returns that player X wins if any of the following conditions are met.
	...
	//Postcondition: Returns that player O wins if any of the following conditions are met.
	...
	//Postcondition: Returns that the game is a draw.
	...
	//Precondition: There is a space input to be checked.
	//Postcondition: Returns whether or not the space has already been marked.
